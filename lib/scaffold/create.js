...
var BASE_PACKAGE = {
  description: 'A full Privy node build with Bitcore',
  repository: 'https://github.com/user/project',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-privy': 'rmoen/bitcore-lib-privy',
    'bitcore-node-privy': 'rmoen/bitcore-node-privy'
  }
};
 ...
 * @param {String} options.network - "testnet" or "mainnet"
